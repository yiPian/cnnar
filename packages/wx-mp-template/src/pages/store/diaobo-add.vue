<template>
    <div class="margin-sm bg-white radius">
       <van-cell-group>
            <van-cell title="单据类型" value="调拨开单" />
            <DatetimeCell title="单据日期" v-model="formData.bill_date"></DatetimeCell>
            <store-cell v-model="formData.store_id" title="调出仓库"></store-cell>
            <store-cell v-model="formData.store_id" title="调入仓库"></store-cell>
       </van-cell-group>
    </div>
    <ProductPanel v-model="formData.products"></ProductPanel>
