<template>
    <div class="bg-white radius margin-sm">
        <van-cell title="组后货品" value="选择组后货品" is-link @click="onOrderShow"/>
...
<script setup lang="ts">
    ...
    import { useRuYinYong, usecombinegoods } from '@/api/store'
    ...
    const onOrderShow = () => {
        ...
        yinYongList.value.length < 1 && queryCombineGoods()
        popupOrderShow.value = true
    }
    const queryCombineGoods = () => {
