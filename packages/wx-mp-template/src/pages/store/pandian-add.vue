<template>
    <div class="margin-sm bg-white radius">
       <van-cell-group>
            <van-cell title="单据类型" value="盘点开单" />
            ...
            <DatetimeCell title="盘点时间" type="datetime" v-model="formData.bill_date"></DatetimeCell>
            <person-cell v-model="formData.pandian_r" title="盘点人员" ></person-cell>
       </van-cell-group>
    </div>
    <ProductPanel type="pandian" v-model="formData.products"></ProductPanel>
    <div class="padding-sm">
        <van-button type="primary" :loading="isLoading" block @click="submit">提交单据</van-button>
    </div>
    <SuccessPanel info-path="store/pandian-info" :id="orderId" ref="successPanel"/>
</template>
<script setup lang="ts">
    ...
    import PersonCell from '@/components/person-cell/index.vue'
