<template>
    <div class="margin-sm bg-white radius">
       <van-cell-group>
            <van-cell title="单据类型" value="调价开单" />
    ...
    <ProductPanel type="tiaojia" v-model="formData.products"></ProductPanel>
    <div class="padding-sm">
        <van-button type="primary" :loading="isLoading" block @click="submit">提交单据</van-button>
    </div>
    <SuccessPanel info-path="store/tiaojia-info" :id="orderId" ref="successPanel"/>
</template>
